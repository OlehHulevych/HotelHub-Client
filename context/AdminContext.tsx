...
import { type ReservationAdmin, type Room} from "../types";
    ...
    useEffect(() => {
        ...
        const fetch = async () =>{
            ...
            if(isAdmin && token!==null){
                try{
                    const [response,reservationResponse, roomResponse, staffResponse] = await Promise.all([
